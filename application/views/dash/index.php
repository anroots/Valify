<div class="alert">
    ...
    <?=__('On :date, the code used to render <strong>:site_name</strong> contained <strong>:errors errors</strong> and <strong>:warnings warnings</strong>, according to the official W3C standards.', array(
